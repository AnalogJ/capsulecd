...
module GithubSource
  ...
  def source_process_push_payload(payload)
    ...
    ValidationUtils.validate_repo_payload(@source_git_head_info)
  ...
  def source_process_pull_request_payload(payload)
    ...
    @source_git_head_info = payload['head']
    ValidationUtils.validate_repo_payload(@source_git_base_info)
    ValidationUtils.validate_repo_payload(@source_git_head_info)
  ...
  def source_release
    ...
    release_body = GitUtils.generate_changelog(@source_git_local_path, @source_git_base_info['sha'], @source_git_head_info['sha'], @source_git_base_info['repo']['full_name'])
