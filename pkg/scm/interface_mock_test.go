...
func (_m *MockInterface) RetrievePayload() (*Payload, error) {
...
func (_m *MockInterface) CheckoutPushPayload(payload *Payload) error {
...
func (_m *MockInterface) CheckoutPullRequestPayload(payload *Payload) error {
