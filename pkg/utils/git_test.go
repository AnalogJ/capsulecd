...
func TestGitClone_InvalidRemote(t *testing.T) {
	t.Parallel()
	...
	//test
	_, cerr := utils.GitClone(dirPath, "test", "this-is-an-invalid-url-remote")

	//assert
	require.Error(t, cerr, "should raise an error if invalid remote")
}
